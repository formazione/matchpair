...
class Generator:
	def __init__(self):
		...
		self.dark = [
			[dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, ],
			[dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, ],
			[dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, ],
			[dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, ],
			[dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, dark_tile, ],
	...
	def shuffle_colors(self):
		''' Increased randomness 29.7.2021 '''
		tiles = []
		...
		print(tiles)
		n = 0
		for nr, row in enumerate(self.lyt):
			self.lyt[nr] = tiles[0+n:8+n]
			n += 8
...
class Win:
	def __init__(self):
		...
		couples = 32
		cols, rows = (8,8)
		size = cols*tile_size, rows*tile_size + 20 

		# hack full screen
		# info = pygame.display.Info()
		# size = sw, sh = info.current_w, info.current_h
	...
	def particles_run(self, pos, color):
	    ...
	    for particle in self.particles[:]:
	        ...
	        # if particle[2] <= 0:
	        if particle[0][1] > 8 - 5 * tile_size or particle[0][0] > 8 - 5 * tile_size:
